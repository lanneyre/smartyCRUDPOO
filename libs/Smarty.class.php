...
/**
 * set SMARTY_CLASS_DIR to absolute path to Smarty internal plugins.
 * Sets SMARTY_CLASS_DIR only if user application has not already defined it.
 */
if (!defined('SMARTY_CLASS_DIR')) {
    /**
     *
     */
    define('SMARTY_CLASS_DIR', SMARTY_DIR . 'class' . DIRECTORY_SEPARATOR);
}
