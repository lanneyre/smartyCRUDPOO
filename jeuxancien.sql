...
--
-- Hôte : localhost:3306
-- Généré le : mer. 12 mai 2021 à 12:28
...
CREATE TABLE IF NOT EXISTS `jeuxvideoanciens` (
  ...
  `réalisateur` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Année` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Palteforme` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `jeuxvideoanciens` (`ID`, `nom`, `réalisateur`, `Année`, `Palteforme`) VALUES
